...
#### 8. 챔피언 검색 기능 구축✔
- 날짜 : 2023.10.11(토) ~ 2023.12.08(금)✔
- 내용 : 챔피언 정보 및 통계 자료 검색 기능 구현 및 UI 디자인 중

#### 9. 서버 도메인 및 HTTPS 배포 완료✔
- 날짜 : 2023.12.09(토) ~ 2023.12.09(토)
- 내용 : 서버 도메인 등록 완료 및 HTTPS 배포 완료
